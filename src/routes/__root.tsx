...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Jogarao Gunda — Associate Professor & Asst HOD TPC, AITAM" },
      { name: "description", content: "Portfolio of Dr. Jogarao Gunda, Associate Professor & Assistant HOD TPC at AITAM Tekkali — 14+ years in academia, Ph.D. in Applied Mathematics." },
      ...
      { property: "og:title", content: "Dr. Jogarao Gunda — Associate Professor & Asst HOD TPC, AITAM" },
      { property: "og:description", content: "14+ years in academia · Ph.D. GITAM University · Asst HOD TPC · Guiding 2 doctoral scholars." },
